    ...
    <Sonner
      ...
      toastOptions={{
        classNames: {
          ...
          success: "group-[.toaster]:border-emerald-500/30 group-[.toaster]:bg-surface-success/15",
          error: "group-[.toaster]:border-destructive/40 group-[.toaster]:bg-surface-danger/10",
          warning: "group-[.toaster]:border-amber-500/40 group-[.toaster]:bg-surface-attention/15",
