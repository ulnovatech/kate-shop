...
export const ADMIN_NAV_SECTIONS: AdminNavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: adminUrl("/team"), label: "Team", icon: Users, permission: "team", keywords: "invite staff" },
      { to: adminUrl("/roles"), label: "Roles", icon: Shield, permission: "roles", keywords: "permissions" },
